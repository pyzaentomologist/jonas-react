...
const newGenres = [...otherGenres, "opic games"];
...
const summary = `Data publikacji: ${getYear(moviePublicationDate)}`;

const spanishTranslation = book.translations.spanish ?? "NOT SPANISH";
spanishTranslation;
...
// 3) Update objects in the array

const bookAfterUpdate = booksAfterDelete
  .map((book) => (book.id === 1 ? { ...book, pages: 10 } : book))
